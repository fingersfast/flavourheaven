            ...
            <div className="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">42 Koramangala Main Road</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mon-Thu: 11:00 AM - 9:00 PM</p>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg
                      className="h-6 w-6 text-gray-600 hover:text-amber-600"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            {isSuccess ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center h-full flex flex-col justify-center">
                ...
                <button
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md transition duration-300 mx-auto"
                >
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="w-full bg-amber-600 hover:bg-amber-700 text-white font-medium py-3 px-4 rounded-md transition duration-300 flex justify-center items-center"
                    >
                      {isSubmitting ? (
                        <>
                          <svg
